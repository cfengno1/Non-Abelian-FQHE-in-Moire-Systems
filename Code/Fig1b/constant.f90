      ...
      Module global
       ...
       integer,parameter :: Nx=16 !4 !System lattice size
      ...
      integer,parameter :: OMPThreads=8
        ...
        integer, parameter::nq1=11,nq2=11, nl=2, nk1=kx0,nk2=ky0
        ...
        complex*16 :: vecf0(nq1*nq2*nl,1:ns0),vecf3(nq1*nq2*nl,1:ns0),vecf(nq1*nq2*nl,1:ns0)
